...
if __name__ == '__main__':
	...
	if len(sys.argv) != 2:
		...
		print '<option> can be 1 => Intelligent Player vs. Human'
		print '                2 => Human vs. Intelligent Player'
		print '                2 => Intelligent Player vs. Random Player'
	...
	option = sys.argv[1]	
	if option == '1':
		obj1 = Intelligent_Player()
		obj2 = Manual_Player()

	elif option == '2':
		obj1 = Manual_Player()
		obj2 = Intelligent_Player()
